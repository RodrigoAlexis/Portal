<div class="container">
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-4">
        ...
        <div>  
            ...
            @else
                <img id="picture" src="{{ asset('/img/defaultProducto1.jpg')}}" alt="Imagen por defecto" >
            @endisset 
        </div>
        ...
        <div>
            ...
            <p class="mt-6 text-sm">2.- Se recomienda que la imagen tenga una medida de 300 x 300 para su correcta visualización.</p>
        </div>
