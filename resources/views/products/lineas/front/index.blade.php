    ...
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="flex flex-col items-center justify-center w-full">
                ...
                <a href="/" class="w-full h-64 bg-gray-300 bg-center bg-cover rounded-xl shadow-md" style="background-image: https://cdn.pixabay.com/photo/2022/01/29/16/21/fisherman-6977946_960_720.jpg ">
