    ...
    <footer class="p-4 bg-white sm:p-6 dark:bg-gray-800">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="https://flowbite.com" class="flex items-center">
                    {{-- <img src="{{ asset('img/Aramo.png') }}" class="mr-3 h-8" alt="Veladoras Aramo Logo"> --}}
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Veladoras
                        Aramo</span>
                </a>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4">
                ...
                <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        <li class="mb-4">
                            <a href="javascript:void(0)" class="hover:underline">Inicio</a>
                        </li>
                        <li class="mb-4">
                            <a href="javascript:void(0)" class="hover:underline">Nosotros</a>
                        </li>
                        <li class="mb-4">
                            <a href="{{ route('blogs.index') }}" class="hover:underline">Blog</a>
                        </li>
                        <li>
                            <a href="{{ route('buzon.index') }}" class="hover:underline">Buzón</a>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        <li class="mb-4">
                            <a href="javascript:void(0)" class="hover:underline ">Refacciones</a>
                        </li>
                        <li class="mb-4">
                            <a href="javascript:void(0)" class="hover:underline">Vidrio</a>
                        </li>
                        <li class="mb-4">
                            <a href="javascript:void(0)" class="hover:underline">Velas y Cirios</a>
                        </li>
                        <li>
                            <a href="javascript:void(0)" class="hover:underline">Eco Velas</a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                ...
                {{-- Linkedin --}}
                <a target="_blank" href="https://mx.linkedin.com/company/veladoras-aramo" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
