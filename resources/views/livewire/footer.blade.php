    ...
    <footer class="p-4 sm:p-6 bg-white">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-2 sm:grid-cols-4">
                ...
                <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        ...
                        <li class="mb-4 text-gray-500 text-md">
                            <span>Teléfono: </span><a href="tel:+522222168201" class="hover:underline">(222) 216
                                8201</a>
                        </li>
        ...
        <div class="sm:flex sm:items-center sm:justify-between ">
            ...
            <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                ...
                {{-- Twitter --}}
                <a target="_blank" href="javascript:void(0)" class="text-gray-500 hover:text-gray-900 ">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path
