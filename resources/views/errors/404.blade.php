...
<body>
    ...
    <div class="min-w-screen min-h-screen bg-blue-100 flex items-center p-5  overflow-hidden relative">
        <div
            ...
            <div class="w-full md:w-1/2">
                ...
                <div class="mb-10 md:mb-20 text-gray-600 font-light">
                    <h1 class="font-black uppercase text-3xl lg:text-5xl text-blue-500 mb-10">¡PARECES ESTAR PERDIDO!
                    </h1>
                    <p>La página que estás buscando no está disponible o no existe.</p>
                    <p>Intente buscar de nuevo o use el botón Volver a continuación.</p>
                </div>
                <div class="mb-20 md:mb-0">
                    <a href="javascript:window.history.back()"
                        class="text-lg font-light outline-none focus:outline-none transform transition-all hover:scale-110 text-blue-500 hover:text-indigo-600"><i
