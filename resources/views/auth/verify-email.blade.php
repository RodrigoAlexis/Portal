                    ...
                    <div class="px-8 pt-6 pb-8 mb-4 bg-white rounded">
                        <form method="POST" action="{{ route('verification.send') }}" >
                            ...
                            <div class="mb-6 text-center mt-4">
                                <button type="submit" class="w-full px-4 py-2 font-bold text-white bg-blue-500 rounded-md hover:bg-blue-700 active:bg-blue-900 focus:outline-none focus:shadow-outline focus:border-gray-900 focus:ring-gray-300">
