                                ...
                                <div class="container">
                                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <x-jet-input id="paterno" class="block mt-1 w-full" type="text"
                                        ...
                                        <div>
                                            ...
                                            <x-jet-input id="materno" class="block mt-1 w-full" type="text"
                                                name="materno" :value="old('materno')" required autofocus
                                                autocomplete="materno" />
                                        </div>
                                        {{-- IsClient? --}}
                                        <div>
                                            <x-jet-label for="isClient"
                                                value="{{ __('¿Es cliente o proveedor? *') }}" />
                                            <div>
                                                ...
                                                border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                                                    ...
                                                    <option value="Soy cliente o proveedor">Si, soy cliente o proveedor
                                                    </option>
                                                    <option value="No soy cliente o proveedor">No soy cliente o
                                                        proveedor</option>
                                                </select>
                                            </div>
                                        </div>
