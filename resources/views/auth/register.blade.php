    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-jet-label for="Si" value="{{ __('Si') }}" />
                <x-jet-input id="isClient" class="block mt-1 w-full" type="radio" name="isClient" value="1" />
                <x-jet-label for="Si" value="{{ __('No') }}" />
                <x-jet-input id="isClient" class="block mt-1 w-full" type="radio" name="isClient" value="0" />
            </div>
