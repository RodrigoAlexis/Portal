            ...
            <div class="container mx-auto">
                <div class="flex justify-center px-6 my-16">
                    ...
                    <div class="w-full xl:w-3/4 lg:w-11/12 flex">
                        <!-- Col -->
                        <div class="w-full h-auto bg-gray-400 hidden lg:block lg:w-1/2 bg-cover rounded-l-lg" style="background-size:465px 470px; background-image: url('https://source.unsplash.com/oWTW-jNGl9I/600x800')"></div>
                        <!-- Col -->
