<x-app-layout>
    ...
    @if (session('success'))
        <div id="alert"
            class="text-white font-bold mb-4 border-0 static  bg-green-500 float-righ text-sm px-6 py-2.5 text-center">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-16 text-gray-600  border-gray-200 border-1 border-b">
            <p>
                El objetivo de este canal es que cualquier persona u organización pueda denunciar y/o comunicar
                cualquier posible conducta irregular, poco ética o inapropiada de cualquier persona que esté empleada,
                represente o participe de alguna forma con nuestra organización, por lo que animamos a empleados/as,
                clientes, usuarios, proveedores o cualquier persona que tenga contacto con nuestros servicios a
                comunicarse con nosotros y hacernos llegar sus sugerencias, denuncias, quejas o cualquier indicio que
                pueda sernos de utilidad.
            </p>
            <p class="mt-4">
                Le agradecemos que nos indique cualquier tipo de detalle de que disponga (fechas, nombre, lugares, etc)
                que pueda ayudarnos en un posible proceso de investigación interno a fin de tener las máximas evidencias
                posibles.
            </p>
        </div>
            ...
            <div class="w-full sm:w-full md:w-full lg:w-3/4 bg-slate-100 flex-auto">
                ...
                <form action="{{ route('buzon.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4"
                        ...
                        <div x-cloak x-show="personal == 'Seguimiento'"
                            class="sm:col-span-1 md:col-span-3 lg:col-span-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <x-jet-input id="paterno" class="block mt-1 w-full" type="text" name="paterno"
                                        :value="old('paterno')" autofocus autocomplete="paterno" />
                                    @error('paterno')
                                        <small class="text-red-600">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <x-jet-input id="materno" class="block mt-1 w-full" type="text" name="materno"
                                        :value="old('materno')" autofocus autocomplete="materno" />
                                    @error('materno')
                                        <small class="text-red-600">{{ $message }}</small>
                                    @enderror
                                </div>
                        ...
                        <div class="col-span-1 md:col-span-2 lg:col-span-2">
                            ...
                            <div>
                                <select @change="cliente = $event.target.value" name="isClient"
                                    class="form-select w-full
                                border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                                    placeholder="Seleccione una opción">
                                    <option value>Seleccione una opción</option>
                        ...
                        <div x-cloak x-show="cliente == 'Soy cliente o proveedor'"
                            class="sm:col-span-1 md:col-span-3 lg:col-span-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                ...
                                <div class="col-span-1 md:col-span-2 lg:col-span-3">
                                    ...
                                    <x-jet-input id="razon_social" class="block mt-1 w-full" type="text"
                                        name="razon_social" :value="old('razon_social')" autofocus autocomplete="razon_social" />
                                </div>
                            </div>
